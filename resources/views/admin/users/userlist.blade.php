    ...
    <div class="container-fluid px-2">
        ...
        <div class="border-0 shadow-lg card mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('users.index') }}" method="GET" class="datatable-top border-bottom">
                    <label>
                    ...
                    @if (request('search'))
                        <label class="ms-3">
                            ...
                            <a href="{{ route('users.index') }}" class="ms-2 btn btn-warning btn-sm">Bỏ tìm kiếm</a>
                        </label>
                    @endif
                ...
                <div class="table-responsive">
                    <table class="table text-center align-middle table-striped">
                        ...
                        <tbody>
                            @foreach ($listAllUsers as $index => $user)
                                <tr class="col-12">
                                    ...
                                    <td class="col-2">
                                        <div class="text-center">
                                            <a class="text-decoration-none btn btn-warning rounded-2"
                                                href="{{ route('users.edit', $user->id) }}">Sửa</a>
